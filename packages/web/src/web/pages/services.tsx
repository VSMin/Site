...
export default function ServicesPage() {
  return (
    <PageLayout>
      <SEO
        title="Услуги"
        description="Полный спектр IT-услуг в Уральске: монтаж сетей, видеонаблюдение, СКУД, обслуживание ПК, телефония, 1С, серверы. KONNEKTEAM — ваш IT-партнёр."
        keywords="IT услуги Уральск, монтаж сети, видеонаблюдение, СКУД, серверы, 1С поддержка"
