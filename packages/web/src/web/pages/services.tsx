...
export default function ServicesPage() {
  return (
    <PageLayout>
      <SEO
        title="Услуги"
        description="Полный спектр IT-услуг в Уральске: монтаж сетей, видеонаблюдение, информационная безопасность, СКУД, 1С, серверы. KONNEKTEAM — ваш IT-партнёр."
        keywords="IT услуги Уральск, интернет, монтаж сети, видеонаблюдение, СКУД, серверы, 1С поддержка"
