  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="KONNEKTEAM — профессиональные IT-услуги в Уральске: сети, видеонаблюдение, обслуживание ПК, СКУД, телефония и многое другое. Выезд за 2 часа."
        keywords="IT услуги Уральск, компьютерная помощь Уральск, видеонаблюдение Уральск, настройка сети Уральск"
