...
const FAQ = [
  ...
  { q: "Работаете с оборудованием любых производителей?", a: "Да — MikroTik, Gigabyte, Hikvision, HP, Dell, Cisco, Lenovo, Dahua, Axis и другие. Наши специалисты сертифицированы по основным вендорам." },
];
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="KONNEKTEAM — интернет для бизнеса, видеонаблюдение, информационная безопасность в Уральске. Выезд специалиста за 2–4 часа. 15 лет опыта, 350+ проектов."
