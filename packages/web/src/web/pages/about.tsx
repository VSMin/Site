...
const TIMELINE = [
  { year: "2010", title: "Основание", desc: "Компания основана в Уральске. Первые проекты — настройка сетей для малого бизнеса." },
  { year: "2016", title: "Расширение", desc: "Добавлено направление видеонаблюдения. Первый крупный корпоративный контракт." },
  { year: "2019", title: "Сертификация", desc: "Получены сертификаты Cisco, Hikvision, MikroTik. Расширение команды сертифицированных специалистов." },
  { year: "2021", title: "Масштаб", desc: "Выход на проекты государственного сектора. 300+ завершённых объектов." },
  { year: "2024", title: "Сегодня", desc: "350+ проектов, 24/7 поддержка, полный спектр IT-услуг для бизнеса любого масштаба." },
];
