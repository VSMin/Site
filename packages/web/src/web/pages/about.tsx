...
const TIMELINE = [
  { year: "2010", title: "Основание", desc: "Компания основана в Уральске. Первые проекты — продажа и заправка картриджей." },
  { year: "2014", title: "Расширение", desc: "Добавлено направление видеонаблюдения. Первый крупный корпоративный контракт." },
  { year: "2016", title: "Сертификация", desc: "Получены сертификаты Hikvision, Dahua. Расширение команды." },
  { year: "2018", title: "Масштаб", desc: "100+ завершённых проектов. Выход на проекты государственного сектора." },
  { year: "2021", title: "Расширение", desc: "Продажи и настройка серверного оборудования." },
  { year: "2023", title: "Лицензия", desc: "Получение лицензии на предоставление услуг связи." },
  { year: "2026", title: "Сегодня", desc: "350+ проектов, 24/7 поддержка, полный спектр IT-услуг для бизнеса любого масштаба. Собственная AS, СОРМ, Сертификация ISO 9001." },
];
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.65)", lineHeight: 1.8, marginBottom: 20 }}>
              {COMPANY.name} — профессиональная IT-компания в Уральске, основанная в 2010 году. Мы специализируемся на комплексных IT-решениях для бизнеса: от проектирования сетей до круглосуточной технической поддержки.
            </p>
            <p style={{ color: "rgba(255,255,255,0.55)", lineHeight: 1.8 }}>
              За 15 лет работы реализовали более 350 проектов для компаний разного масштаба — от небольших магазинов до крупных производственных предприятий и государственных структур.
            </p>
          </div>
