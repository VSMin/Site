...
const TEAM = [
  ...
  { name: "Андрей Артемьев", role: "Начальник технического отдела", desc: "Сертифицированный Mikrotik MTCRE. Проектировал сети для 60+ коммерческих объектов." },
  { name: "Максим Кузнецов", role: "Руководитель отдела продаж", desc: "Сопровождение клиентов от первичной заявки до закрытия проекта. Опыт более 10 лет." },
  { name: "Александр Тимошук", role: "Ведущий инженер по видеонаблюдению", desc: "Монтаж и настройка CCTV систем — Hikvision, Dahua. 50+ реализованных объектов." },
];
...
const TIMELINE = [
  ...
  { year: "2026", title: "Сегодня", desc: "350+ проектов, 24/7 поддержка, полный спектр IT-услуг для бизнеса любого масштаба. Собственная AS. Внедрение СОРМ. Сертификация ISO 9001" },
];
