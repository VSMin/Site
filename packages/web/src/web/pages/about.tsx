...
const TIMELINE = [
  ...
  { year: "2020", title: "Сертификация", desc: "Получены сертификаты Hikvision, MikroTik. Расширение команды специалистов." },
  { year: "2023", title: "Интернет", desc: "Получение лицензии на предоставление услуг связи. Выход на проекты по услугам связи для государственных компаний. " },
