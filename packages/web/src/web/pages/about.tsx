...
const TEAM = [
  { name: "Алихан Джаксыбеков", role: "Генеральный директор", desc: "10+ лет в IT-индустрии, специализация — сетевая инфраструктура и проектное управление." },
  { name: "Дамир Утегенов", role: "Ведущий сетевой инженер", desc: "Сертифицированный Cisco CCNA. Проектировал сети для 50+ коммерческих объектов." },
  { name: "Асель Нурмаганбетова", role: "Менеджер по работе с клиентами", desc: "Сопровождение клиентов от первичной заявки до закрытия проекта. Опыт 6 лет." },
  { name: "Руслан Кубенов", role: "Специалист по видеонаблюдению", desc: "Монтаж и настройка CCTV систем — Hikvision, Dahua, Axis. 200+ реализованных объектов." },
];

const TIMELINE = [
  { year: "2014", title: "Основание", desc: "Компания основана в Уральске. Первые проекты — настройка сетей для малого бизнеса." },
  { year: "2016", title: "Расширение", desc: "Добавлено направление видеонаблюдения. Первый крупный корпоративный контракт." },
  { year: "2019", title: "Сертификация", desc: "Получены сертификаты Cisco, Hikvision, MikroTik. Расширение команды до 12 специалистов." },
  { year: "2021", title: "Масштаб", desc: "Выход на проекты государственного сектора. 300+ завершённых объектов." },
  { year: "2024", title: "Сегодня", desc: "500+ проектов, 24/7 поддержка, полный спектр IT-услуг для бизнеса любого масштаба." },
];
...
export default function AboutPage() {
  return (
    <PageLayout>
      <SEO
        title="О компании"
        description="KONNEKTEAM — IT-компания в Уральске с 2014 года. 500+ реализованных проектов, команда сертифицированных специалистов, гарантия качества."
        keywords="о компании KONNEKTEAM, IT компания Уральск, история компании, команда специалистов"
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.55)", lineHeight: 1.8 }}>
              За 10 лет работы реализовали более 500 проектов для компаний разного масштаба — от небольших магазинов до крупных производственных предприятий и государственных структур.
            </p>
          </div>
